...
gcc -fpic -c -I$mdPhonePath -I$JavaIncludeDirectory1 -I$JavaIncludeDirectory2 mdPhoneJavaWrapper.cpp
gcc -g -shared mdPhoneJavaWrapper.o -o libmdPhoneJavaWrapper.so -L$mdPhonePath -lmdPhone -pthread
