# Melissa - Phone Object Java Wrappers

## Purpose
This is the code for you to run Phone Object in Java.
...
- Melissa Phone Object for 2023-05
...
```
$ https://github.com/MelissaData/PhoneObject-Java-Wrappers.git
$ cd PhoneObject-Java-Wrappers
```

### Copy wrappers to your project folder
Import the `com` folder, and `mdPhoneJavaWrapper.dll` (Windows) or `libmdPhoneJavaWrapper.so` (Linux) to your project, and include the following line in your code to begin using the wrapper.
...
#### Configure Scripts
If you want to generate `mdPhoneJavaWrapper.dll`, you will execute the `BuildPhoneJavaWrapper.ps1` script. This may require you to configure some path variables in `BuildWrapper.ps1` and `BuildPhoneJavaWrapper.ps1`.

BuildPhoneJavaWrapper.ps1
...
It is important to note that you must be able to initialize the Visual Studio Developer Command Prompt environment for `x86_x64` to generate `mdPhoneJavaWrapper.dll`.
...
```
$ .\BuildPhoneJavaWrapper.ps1
$ .\BuildPhoneJavaWrapper.ps1 -license "<your_license_string>"
```
...
#### Configure Script
If you want to generate `libmdPhoneJavaWrapper.so`, you will execute the `BuildPhoneJavaWrapper.sh` script. This may require you to configure some path variables in `BuildPhoneJavaWrapper.sh`.

BuildPhoneJavaWrapper.sh
- Check the `JavaIncludeDirectory1` variable and configure the path to the `include` folder if needed
- Check the `JavaIncludeDirectory2` variable and configure the path to the `win32` folder if needed
...
```
$ ./BuildPhoneJavaWrapper.sh
$ ./BuildPhoneJavaWrapper.sh --license "<your_license_string>"
```

----------------------------------------
## See also
- [Melissa - Phone Object Windows Java](https://github.com/MelissaData/PhoneObject-Java)
- [Melissa - Phone Object Linux Java](https://github.com/MelissaData/PhoneObject-Java-Linux)
