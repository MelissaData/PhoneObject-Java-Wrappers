...
- Melissa Phone Object for 2025-05
...
#### Configure Scripts
If you want to generate `mdPhoneJavaWrapper.dll`, you will execute the `BuildPhoneJavaWrapper.ps1` script. This may require you to configure some path variables in `Build.ps1` and `BuildPhoneJavaWrapper.ps1`.
